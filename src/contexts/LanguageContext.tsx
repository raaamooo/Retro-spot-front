...
const translations: Record<string, { en: string; ar: string }> = {
  ...
  transfer_via_wallet: { en: 'Transfer via Vodafone Cash, Orange Cash, or e& Cash to the number below:', ar: 'حوّل عن طريق فودافون كاش أو أورانج كاش أو اتصالات كاش على الرقم ده:' },
